...
lv.postDelayed(new Runnable() {
    ...
    private void inithelper(int page) {
      new Helper().get("http://172.17.8.100/movieApi/movie/v1/findHotMovieList?userId=18&sessionId=15320748258726&page="+page+"&count=10").Result(new Helper.HttpListener() {
          @Override
